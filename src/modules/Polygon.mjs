...
export default class Polygon extends Body {
	...
	/**
	 * Overrides JSON.stringify behaviour.
	 * Returns an object containing all parameters needed to recreate 
	 * an instance of this polygon.
	 */
	toJSON() {
		const result = {
			x: this.x,
	...
	/**
	 * 
	 * @param {Object} obj Object generated by `toJSON`
	...
	static fromJSON(obj) {
		...
		return new Polygon(x, y, points, angle, scale_x, scale_y, padding);
	}
};
